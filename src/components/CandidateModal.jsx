...
export const CandidateModal = ({
  ...
  const scrollToSection = (id) => {
    ...
    if (container && element) {
      ...
      container.scrollTo({
        top: relativeTop - 12, // offset for padding
        behavior: 'smooth'
      });
    }
  };
  ...
  useEffect(() => {
    ...
    const sections = modalSections
      .map((sec) => document.getElementById(`sec-${sec.id}`))
      .filter(Boolean);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-md">
      ...
      <div className="bg-white rounded-3xl border border-violet-200 shadow-2xl w-full max-w-5xl h-[88vh] flex flex-col md:flex-row overflow-hidden">
        ...
        <main className="flex-1 flex flex-col h-full min-h-0 overflow-hidden bg-white">
          ...
          {/* Body Window - rendering all sections in order */}
          <div
            ref={scrollContainerRef}
            className="flex-1 overflow-y-auto min-h-0 p-6 space-y-12 scroll-smooth"
          >
            ...
            <div id="sec-experience" className="space-y-4 pt-2">
            ...
            {/* SECTION 6: EDUCATION */}
            <div id="sec-education" className="space-y-4 pt-2">
            ...
            <div id="sec-projects" className="space-y-4 pt-2">
            ...
            <div id="sec-ai-report" className="space-y-4 pt-2">
            ...
            <div id="sec-coding" className="space-y-5 pt-2">
