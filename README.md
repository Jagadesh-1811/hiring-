...
- **Components**: Radix UI Dropdown Menu
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Jagadesh-1811/hiring-.git
   cd hiring-
   ```
...
├── src/
│   ├── components/      # UI & layout components (Search, Filter, CandidateCard, etc.)
│   ├── data/            # Mock candidate datasets and constants
